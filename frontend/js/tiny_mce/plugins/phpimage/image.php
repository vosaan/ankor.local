...
<head>
	...
	<script type="text/javascript" src="js/image.js?2100"></script>
						...
						<table class="properties">
							<tr>
								<td>
									...
									<input type="submit" id="insert" name="insert" value="{#phpimage_dlg.upload}" style="float: right; clear: both" />
									<div style="clear: both"></div>
									<input type="checkbox" name="orig" value="1" /> {#phpimage_dlg.orig_size}
								</td>
							</tr>
						</table>
				</fieldset>
