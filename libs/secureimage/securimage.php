...
class Securimage {
   ...
   * @var string
   */
  var $charset = 'ABCDEFGHJKMNPRSTWXYZ23456789';
  ...
  function Securimage()
  {
    ...
    $this->ttf_file = dirname( __FILE__ ).'/'.ltrim( $this->ttf_file, './\\' );
  }
  ...
  function arcLines()
  {
    ...
    $width  = $this->image_width / 3.66 + rand(3, 10);
    $height = $this->font_size * 3.14 - rand(3, 10);
